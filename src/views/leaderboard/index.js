...
const rows = [
  createData(1, "Nisarg Mehta",'ABC Pvt Ltd', 14678),
  createData(2, "Virat Kothari", 'BBC Enterprise', 13278),
  createData(3, "Aatish Motipara", 'XYZ Services Pvt Ltd', 12984),
  createData(4, "Vaibhav Palan", 'Sample Company Inc', 11746),
  createData(5, "Bhavesh Gandhi",'Envelope Technologies', 10536),
];
